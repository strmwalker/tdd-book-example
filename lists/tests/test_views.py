...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='other list item 1', list=another_list)
        Item.objects.create(text='other list item 2', list=another_list)
...
class NewListTest(TestCase):
    ...
    def test_for_invalid_list_items_arent_saved(self):
